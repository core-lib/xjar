 ...
 * 2018/11/24 13:57
 */
public class XWarURLConnection extends JarURLConnection {
    ...
    public XWarURLConnection(JarURLConnection jarURLConnection, XDecryptor xDecryptor, XEncryptor xEncryptor, XKey xKey) throws MalformedURLException {
